export function renderWeather(data) {
  ...
  document.getElementById("location").innerText = data.forecast.city.name;
  ...
  document.getElementById("pressure").innerText = current.main.pressure + " mb";
...
function setAnimatedIcon(weather) {
  ...
  switch (weather) {
    ...
    case "Clouds":
      src =
        "https://lottie.host/ea009255-95a7-409b-aef3-8cceccf90e1a/H43Lbd2vfT.json";
      break;

    case "Rain":
      src =
        "https://lottie.host/3c137a81-1d86-4c0c-bddc-c9f55dee9c57/KQbxexxjcZ.json";
      break;

    case "Snow":
      src =
        "https://lottie.host/9654c905-0041-4c0f-8221-a74a1213b69d/YS1oNh7Fz4.json";
      break;

    case "Thunderstorm":
      src =
        "https://lottie.host/d8e8d307-b6a9-4290-b0b0-d89982608af8/GNSYl5q3XA.json";
      break;
